...
def test_frontend_assets_use_current_cache_key():
    ...
    assert "/app.js?v=20260724-canonical-dashboard-v5.3" in index
    assert "/styles.css?v=20260724-canonical-dashboard-v5.3" in index
    assert "/recommendation-visuals.js?v=20260724-canonical-dashboard-v5.3" in index
